...
public class TopicServiceTest {
    ...
    @Test
    public void whenSourceNameCreateInGetRequestThenResult() {
    ...
    @Test
    public void whenSourceNameCreateInPostRequestThenResult() {
        TopicService topicService = new TopicService();
        String paramForPublisher = "temperature=18";
        String paramForSubscriber1 = "client407";
        String paramForSubscriber2 = "client6565";
        /* Режим topic. Cоздаем новый топик weather через Post(). */
        topicService.process(
                new Req("POST", "topic", "weather", paramForPublisher)
        );
        /* Режим topic. Подписываемся на топик weather. client407. */
